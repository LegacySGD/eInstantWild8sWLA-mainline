...
public class Wild8sWLAWLAEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(Wild8sWLAWLAEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/Wild8sWLAIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/Wild8sWLAIW/InitOutcome.xml").getDocumentElement();
